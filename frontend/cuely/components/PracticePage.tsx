...
export default function PracticePage({
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-[#E1D3BE]">
      {/* Progress Bar */}
      <div className="w-full py-6 px-8 bg-white/50 backdrop-blur-sm">
        ...
        <div className="max-w-6xl w-full h-full flex flex-col">
          <div className="pt-4 grid grid-cols-2 gap-8 h-full overflow-hidden">
            ...
            <div className="flex flex-col justify-center bg-white p-8 rounded-2xl shadow-sm">
              ...
              <div className="mb-6">
                <h3 className="text-sm uppercase tracking-wider text-gray-500 font-semibold mb-2">Context</h3>
              ...
              <div className="mb-6">
                <h3 className="text-sm uppercase tracking-wider text-gray-500 font-semibold mb-2">Your Goal</h3>
            ...
            <div className="flex flex-col bg-white p-8 rounded-2xl shadow-sm relative overflow-hidden">
              ...
              {practicePhase === 'listen' && (
                <div className="flex-1 flex flex-col justify-center items-center text-center animate-in fade-in slide-in-from-right-4 duration-300">
                  <div className="w-16 h-16 bg-[#5E7381]/10 rounded-full flex items-center justify-center mb-6 text-[#5E7381]">
                  ...
                  <div className="w-full max-w-sm h-12 bg-gray-200 rounded-full mb-8 flex items-center justify-center text-gray-500 text-sm">
                ...
                <div className="flex-1 flex flex-col animate-in fade-in slide-in-from-right-4 duration-300 h-full">
                  ...
                  <div className="flex justify-between items-center mt-auto pt-4 border-t border-gray-100">
                    ...
                    <button
                      ...
                      className={`px-8 py-3 rounded-xl font-semibold transition-all shadow-lg flex items-center ${
